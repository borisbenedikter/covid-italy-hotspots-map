function icu_max = get_region_icu_max(ID_reg)
    ...
    reg_icu_max{09, 1} = 523;       % Toscana
    reg_icu_max{10, 1} = 101;       % Umbria
    reg_icu_max{02, 1} = 20;        % Valle
    reg_icu_max{05, 1} = 1016;      % Veneto
    reg_icu_max{04, 1} = 1;         % ---

    icu_max = reg_icu_max{ID_reg, 1};

    % SRC: https://lab24.ilsole24ore.com/coronavirus/ (02/Nov/2020)
end
